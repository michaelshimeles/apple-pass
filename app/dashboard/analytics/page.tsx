      ...
      <div className="p-6 space-y-4">
        <div className="flex justify-between items-center">
          ...
          {userPasses?.length ? (
            <PassSelector
              defaultPassId={
                intialPassId ? intialPassId : Number(params?.passId)
              }
        ...
        {userPasses?.length ? (
          ...
          <div className="flex flex-col items-center justify-center h-[80vh] text-center p-8 border rounded-lg bg-muted/30">
